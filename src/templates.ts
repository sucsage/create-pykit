...
export const ALL_DEPS = [
  ...
  { value: 'ultralytics',     label: 'ultralytics',     hint: 'YOLOv8/v11 object detection' },
  { value: 'roboflow',        label: 'roboflow',        hint: 'dataset management + model deployment' },
  { value: 'tensorflow',      label: 'tensorflow',      hint: 'deep learning framework (Google)' },
  { value: 'keras',           label: 'keras',           hint: 'high-level neural networks (TF backend)' },
